...
- Shop card: two-column 220 × 330 minimum card with contained 150 px art. Pet flavor descriptions stay hidden and are replaced by concise two-line ability summaries; all summary copy uses 16 px outlined NERILLKID text.
...
- Store frame: full-screen `LongFrame.png`, a left illustrated category rail, a compact currency header, and a bottom-anchored utility row.
- Shop tabs: supplied Pets, Power-Ups, Skins, and Themes art; active is full-bright and 106%, inactive is cool-tinted and 92%.
...
- Game Over: illustrated Home/Restart/Settings actions inside the blue portrait frame, with a clipped live snapshot of the run's final pile and a short flash/settle reveal.
